    ...
    <div className="bg-primary-light/10 border border-white/5 rounded-3xl p-6 mt-6 space-y-6 relative overflow-hidden">
      <div className="flex items-center gap-4 border-b border-white/5 pb-3">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-500 font-sans mt-0.5">{t('admin:ai_settings.stt_desc', { defaultValue: 'Verwalten Sie die Einstellungen für lokale oder Cloud-basierte Spracherkennungsmodelle (Whisper).' })}</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Provider Selection */}
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_provider_label', { defaultValue: 'STT Provider' })}</label>
            <select
              value={sttProvider}
              onChange={(e) => {
          ...
          {/* Model Name */}
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_model_label', { defaultValue: 'Modellname' })}</label>
            <input
              type="text"
              required
          ...
          {/* Connection Endpoint */}
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_endpoint_label', { defaultValue: 'Endpoint-URL' })}</label>
            <input
              type="text"
              required
              disabled={sttProvider === 'disabled'}
          ...
          {/* Secret Key */}
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_key_label', { defaultValue: 'API Key / Token (Optional)' })}</label>
            <input
              type="password"
              disabled={sttProvider === 'disabled'}
              value={sttApiKey}
          ...
          {/* Detection Language */}
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_language_label', { defaultValue: 'Erkennungssprache' })}</label>
            <input
              type="text"
              disabled={sttProvider === 'disabled'}
              value={sttLanguage}
          ...
          <div className="space-y-1.5 md:col-span-2">
            <label className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_prompt_label', { defaultValue: 'Erkennungshilfen (Prompt / Keywords)' })}</label>
            <input
              type="text"
              disabled={sttProvider === 'disabled'}
              value={sttPrompt}
            ...
            />
            <p className="text-[9px] text-slate-500 font-sans leading-normal">{t('admin:ai_settings.stt_prompt_help', { defaultValue: 'Begriffe, die Whisper bevorzugt annehmen soll um Fachbegriffe besser zu verstehen.' })}</p>
          </div>
        </div>
        ...
        {sttProvider === 'local-whisper' && (
          <div className="pt-4 border-t border-white/5 space-y-4">
            <h5 className="text-[10px] font-black text-violet-400 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_hardware_title', { defaultValue: 'Lokale Hardware & VRAM Optimierungen' })}</h5>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Device select */}
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_device_label', { defaultValue: 'Recheneinheit (Device)' })}</label>
                <select
                  value={sttDevice}
              ...
              {/* Quantization select */}
              <div className="space-y-1.5">
                <label className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-display">{t('admin:ai_settings.stt_quantization_label', { defaultValue: 'Quantisierung' })}</label>
                <select
              ...
              <div className="flex items-center justify-between p-3.5 bg-primary-dark rounded-xl border border-white/5">
                <div>
                  ...
                  <span className="text-[9px] text-slate-500 block leading-tight mt-0.5">{t('admin:ai_settings.stt_unload_llm_desc', { defaultValue: 'Entlastet die GPU vor dem Start des Transkriptionsprozesses vram-intelligent.' })}</span>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex items-center justify-between p-3.5 bg-primary-dark rounded-xl border border-white/5">
                <div>
                  ...
                  <span className="text-[9px] text-slate-500 block leading-tight mt-0.5">{t('admin:ai_settings.stt_failsafe_cpu_desc', { defaultValue: 'Weicht bei OOM-Fehlern der GPU automatisch auf CPU-Berechnung aus.' })}</span>
                </div>
                <input
                  type="checkbox"
        ...
        <div className="border-t border-white/5 pt-4 flex justify-end">
          <button
            ...
            className="bg-gradient-to-tr from-violet-500 to-violet-600 hover:scale-105 active:scale-95 transition-transform duration-300 text-white font-black uppercase text-[10px] tracking-widest px-5 py-2.5 rounded-xl flex items-center gap-1.5 shadow-lg cursor-pointer"
          >
      ...
      <div className="bg-primary-light/10 border border-white/5 rounded-3xl p-6 mb-8 space-y-6">
        ...
        <div className="border-t border-white/5 pt-4 flex justify-end">
          <button
            ...
            className="bg-gradient-to-tr from-accent-orange to-accent-orange/80 hover:scale-105 active:scale-95 transition-transform duration-300 text-white font-black uppercase text-[10px] tracking-widest px-5 py-2.5 rounded-xl flex items-center gap-1.5 shadow-lg hover:shadow-accent-orange/20 cursor-pointer"
          >
      ...
      <div className="bg-primary-light/10 border border-white/5 rounded-3xl p-6 mb-8 space-y-6">
        ...
        <div className="border-t border-white/5 pt-4 flex justify-end">
          <button
            ...
            disabled={saveMutation.isPending}
            className="bg-gradient-to-tr from-accent-blue to-blue-600 hover:scale-105 active:scale-95 transition-transform duration-300 text-white font-black uppercase text-[10px] tracking-widest px-5 py-2.5 rounded-xl flex items-center gap-1.5 shadow-lg hover:shadow-accent-blue/20 cursor-pointer"
          >
            {saveMutation.isPending ? (
              <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
            ) : (
      ...
      <div data-testid="react-runtime-settings" className="bg-primary-light/10 border border-white/5 rounded-3xl p-6 mb-8 space-y-6">
        ...
        <div className="border-t border-white/5 pt-4 flex justify-end gap-3">
          <button
            ...
            className="px-4 py-2.5 border border-white/10 text-slate-400 hover:text-white hover:bg-white/5 transition-all rounded-xl font-bold uppercase text-[10px] tracking-widest cursor-pointer"
          >
