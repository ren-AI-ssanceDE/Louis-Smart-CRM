...
import { McpClientSettingsTab } from './McpClientSettingsTab';
import { McpToolMappingsPanel } from './McpToolMappingsPanel';
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <div className="space-y-6">
          <h4 className="text-[10px] font-black text-accent-orange uppercase tracking-[0.2em] font-display border-b border-white/5 pb-2 font-sans">
            MODEL CONTEXT PROTOCOL (MCP) SERVER (INBOUND)
          </h4>
          <McpSettingsForm />
        </div>

        {/* Model Context Protocol (MCP) External Clients & Discovery Hub */}
        <div className="space-y-6">
          <h4 className="text-[10px] font-black text-accent-orange uppercase tracking-[0.2em] font-display border-b border-white/5 pb-2 font-sans">
            MODEL CONTEXT PROTOCOL (MCP) EXTERNAL CLIENTS & HUB (OUTBOUND)
          </h4>
          <McpClientSettingsTab />
        </div>

        {/* MCP Tool Mappings & Test Execution Center */}
        <div className="space-y-6">
          <h4 className="text-[10px] font-black text-accent-orange uppercase tracking-[0.2em] font-display border-b border-white/5 pb-2 font-sans">
            MCP TOOL DOMAIN MAPPINGS & TEST CENTER
          </h4>
          <McpToolMappingsPanel />
        </div>
      </div>
    </div>
  );
