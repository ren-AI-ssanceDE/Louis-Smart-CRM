  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (checkSession && checkSession.user) {
        // Clear explicit logout cookie so default login can kick in again on page reload
        document.cookie = "explicit_logout=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT";
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder={t('login:email_placeholder', { defaultValue: 'admin@louis-crm.de' })}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder={t('login:password_placeholder', { defaultValue: '••••••••' })}
