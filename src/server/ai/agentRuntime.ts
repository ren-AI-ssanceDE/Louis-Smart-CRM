...
export const SYSTEM_TOOL_CATALOG: DefinedToolDescriptor[] = [
 ...
 // G2/G4 : Update-Tools + Notizen-Vollverwaltung
  ...
  { name: "update_contact_draft", desc: "'update_contact_draft': Aktualisiert einen bestehenden Kontakt (Partial-Update, inkl. Opt-in-Felder). full_legal_name wird bei Namensänderung (first_name/last_name) automatisch neu berechnet. Query JSON: { id_uuid, first_name?, last_name?, email_address?, phone_number?, opt_in_marketing?, ... }", domain: 'CRM_WRITE' },
