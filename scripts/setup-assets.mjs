...
const ASSETS = [
  ...
  {
    label: "Lato Italic",
    dest: join(ROOT, "src/assets/fonts/Lato-Italic.ttf"),
    url: "https://raw.githubusercontent.com/google/fonts/main/ofl/lato/Lato-Italic.ttf",
    minBytes: 50_000,
  },
  {
    label: "Lato BoldItalic",
    dest: join(ROOT, "src/assets/fonts/Lato-BoldItalic.ttf"),
    url: "https://raw.githubusercontent.com/google/fonts/main/ofl/lato/Lato-BoldItalic.ttf",
    minBytes: 50_000,
  },
  {
